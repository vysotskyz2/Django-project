...
@extend_schema_view(
    ...
    partial_update=extend_schema(
        summary="Частично обновить позицию склада", tags=["Dealership Inventory"]
    ),
...
@extend_schema_view(
    list=extend_schema(
        summary="Список предпочтений автосалона по машинам", tags=["Dealership Preferences"]
    ),
    ...
    partial_update=extend_schema(
        summary="Частично обновить предпочтение", tags=["Dealership Preferences"]
    ),
...
@extend_schema_view(
    ...
    retrieve=extend_schema(
        summary="Лучший поставщик для пары автосалон × модель", tags=["Best Suppliers"]
    ),
)
class DealershipBestSupplierViewSet(
    ...
    queryset = DealershipBestSupplier.objects.select_related("dealership", "car", "supplier").all()
