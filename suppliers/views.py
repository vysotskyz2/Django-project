...
@extend_schema_view(
    ...
    create=extend_schema(
        summary="Добавить позицию на склад поставщика", tags=["Supplier Inventory"]
    ),
    retrieve=extend_schema(
        summary="Получить позицию склада поставщика", tags=["Supplier Inventory"]
    ),
    update=extend_schema(summary="Обновить позицию склада поставщика", tags=["Supplier Inventory"]),
    partial_update=extend_schema(
        summary="Частично обновить позицию склада поставщика", tags=["Supplier Inventory"]
    ),
...
@extend_schema_view(
    ...
    partial_update=extend_schema(
        summary="Частично обновить акцию поставщика", tags=["Supplier Promotions"]
    ),
