...
from buyers.factories import BuyerCarPreferenceFactory, BuyerFactory
...
class TestBuyerOfferService:
    ...
    def test_skips_if_unverified_email(self):
        ...
        car = CarFactory()
        DealershipInventoryFactory(
            dealership=dealership, car=car, quantity=5, price_per_unit=Money(20_000, "USD")
        )
    ...
    def test_skips_if_no_balance(self):
        ...
        car = CarFactory()
        DealershipInventoryFactory(
            dealership=dealership, car=car, quantity=5, price_per_unit=Money(1000, "USD")
        )
        Offer.objects.create(
            buyer=buyer,
            car=car,
